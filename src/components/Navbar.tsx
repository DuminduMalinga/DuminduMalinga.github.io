    ...
    <>
      <nav id="navbar" className={scrolled ? 'scrolled' : ''} role="navigation" aria-label="Main navigation">
        <div className="nav-inner container">
          ...
          <div className="nav-actions">
            ...
            <a href={personal.cvUrl} className="btn btn-primary nav-cta" download aria-label="Download CV">
      ...
      <div ref={drawerRef} id="mobile-nav" className={mobileOpen ? 'open' : ''} role="dialog" aria-label="Mobile navigation">
        <div className="mobile-nav-inner">
          ...
          <a href={personal.cvUrl} className="btn btn-primary" download style={{ marginTop: '12px', justifyContent: 'center' }}>
            Download CV
          </a>
        </div>
      </div>
