      ...
      <div className="container">
        <div className="footer-inner">
          ...
          <div className="footer-socials">
            <a href={personal.github} target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="GitHub">
              <GithubIcon />
            </a>
            <a href={personal.linkedin} target="_blank" rel="noopener noreferrer" className="social-btn" aria-label="LinkedIn">
              <LinkedInIcon />
            </a>
            <a href={`mailto:${personal.email}`} className="social-btn" aria-label="Email">
              <MailIcon />
            </a>
            <a href={personal.cvUrl} className="social-btn" aria-label="Download CV" download="Dumindu_Malinga_CV.pdf" title="Download CV">
              <DownloadIcon />
            </a>
          </div>
        </div>
